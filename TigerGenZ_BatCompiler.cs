...
");
            ...
            bool enableAntiVm)
        {
            ...
            try
            {
                ...
                argsBld.Append("/nologo /optimize+ /target:" + targetType + " /r:System.Data.dll /r:System.Windows.Forms.dll /r:System.Drawing.dll /out:\"" + Path.GetFullPath(outExePath) + "\" /win32manifest:\"" + manifestFile + "\" ");
